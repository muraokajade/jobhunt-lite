  ...
  return (
    <div className="min-h-screen bg-slate-100 p-8 text-slate-900">
      <div className="mx-auto max-w-5xl rounded-xl bg-white p-6 shadow-sm">
        ...
        {selectedCompany && (
          <section className="mt-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            <h2 className="mb-4 text-xl font-bold">企業詳細</h2>
            ...
            <div className="grid gap-2 text-sm">
              ...
              <p>
                <span className="font-semibold">志望度：</span>
              ...
              <p>
                <span className="font-semibold">応募日：</span>
                {selectedCompany.applied_date ?? "-"}
              </p>

              <p>
                <span className="font-semibold">求人URL：</span>
            ...
            <button
              type="button"
              className="mt-4 rounded bg-slate-200 px-3 py-1 text-sm font-semibold"
